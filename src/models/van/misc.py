...
def get_batch_norm_op(args):
    if args.device_target == "GPU" or int(args.device_num) == 1:
        return BatchNorm2d
    elif args.device_target == "Ascend" and int(args.device_num) > 1:
        return SyncBatchNorm
    else:
        raise ValueError("Not suppported param for batch norm op!")
